...
const ClientMergeIntoRequest = z
    .object({ client_id: z.string(), name_client_id: z.string() })
    .passthrough();
...
const OrganizationResource = z
    .object({
        ...
        shop_report_enabled: z.boolean(),
        shop_report_logo: z.union([z.string(), z.null()]),
        currency: z.string(),
...
const endpoints = makeApi([
    ...
    {
        method: 'post',
        path: '/v1/organizations/:organization/clients/:client/merge-into',
        alias: 'mergeClient',
        requestFormat: 'json',
        parameters: [
            {
